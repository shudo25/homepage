...
def ci_presentation_v3():
    """CI構想プレゼンテーション v4版 - さとうささら音声合成版
    
    v4改訂のポイント（v3からの変更）：
    - スライド数を25枚→26枚に微増
    - 「魔法の循環」の課題・限界を明示（新スライド16）
    - 高橋先生への質問誘導を追加
    - より現実的な期待値設定
    ...
    time.sleep(1)
    t.speak("実は今日のお話、ちょっと深刻なテーマも含んでいるんですが、")
    ...
    print("=== スライド4: 地球という船 ===")
    t.speak("まず、今の地球の状況を、ちょっと比喩を使って見てみますね。")
    time.sleep(1)
    t.speak("想像してみてください。")
    ...
    # === 注意喚起：課題と限界 ===
    print("=== スライド16: ちょっと待って！正直に言うと... ===")
    t.speak("でも、ちょっと待ってください！")
    time.sleep(1)
    t.speak("ここで正直に言わないといけないことがあります。")
    time.sleep(1)
    t.speak("この「魔法の循環」、実は課題もあるんです。")
    time.sleep(1)
    t.speak("課題1、みんなの参加が絶対必要。")
    t.speak("一人一人が発信してくれないと、この循環は始まりません。")
    t.speak("「誰かがやってくれる」じゃダメなんです。")
    t.speak("みんなが参加して初めて成り立つ仕組みなんですね。")
    time.sleep(1.5)
    t.speak("課題2、時間がかかります。")
    t.speak("魔法じゃないので、すぐには結果が出ません。")
    t.speak("蓄積して、学習して、だんだん賢くなっていく...って感じです。")
    t.speak("焦らず、じっくり育てていく必要があります。")
    time.sleep(1.5)
    t.speak("課題3、AIも完璧じゃない。")
    t.speak("AIって賢いんですけど、時々間違えることもあります。")
    t.speak("人間が確認したり、修正したりする必要があるんです。")
    time.sleep(2)
    t.speak("でも！")
    time.sleep(0.5)
    t.speak("こういう課題があっても、")
    t.speak("「やってみる価値は絶対ある！」とわたしは思います！")
    time.sleep(1.5)
    t.speak("もっと詳しい仕組みとか、専門的なことは、")
    t.speak("高橋先生の方が詳しいので、")
    t.speak("後で質問があったら、先生に聞いてくださいね！")
    time.sleep(1)
    t.speak("わたしは、わかりやすく説明する担当です！")
    input("次のスライドに進むにはEnterを押してください...")
    
    # === 第4部：修道25回生の実験！ ===
    print("=== スライド17: 第4部タイトル ===")
    t.speak("さて、気を取り直して！")
    time.sleep(0.5)
...
if __name__ == "__main__":
    print("CI構想プレゼンテーション v4版 - さとうささら音声合成版")
    print("========================================")
    print("v4の改善点:")
    print("- スライド数: 25枚 → 26枚に微増")
    print("- 「魔法の循環」の課題・限界を明示")
    print("- 高橋先生への質問誘導を追加")
    print("- より現実的な期待値設定")
    print()
    print("v3の改善点:")
